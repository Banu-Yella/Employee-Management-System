    ...
    <EmployeeLayout>
      <div className="dashboard-container">
        <div className="dashboard-welcome mb-4">
          ...
          <p>Track your profile, attendance, leave, and daily work updates from one place.</p>
        </div>
        ...
        <div className="dashboard-row">
          <div className="dashboard-card">
            ...
            <p className="text-muted">You are currently marked present for today.</p>
            <div className="action-buttons mt-3">
              <button className="btn btn-primary">View Attendance</button>
              <button className="btn btn-outline-secondary">Request Leave</button>
            </div>
          </div>

          <div className="dashboard-card">
            <h3>Profile & Contact</h3>
            <p><strong>Name:</strong> {user?.username || "Employee User"}</p>
