...
const UpdateUserEducation = () => {
    ...
    useEffect(() => {
        api.get('getEducationById/{educationId}')
            .then((res) => {
    ...
    let updateData = (e) => {
        ...
        api.put(`/updateEducation/{educationId}`, payload)
            .then(() => {
            ...
            <div className="card-body">
               <form>
                  <div className="row">
                     ...
                     <button type="button" class="btn btn-danger me-3" onClick={() => navigate('/UserEducation')}>Cancel</button>
                     </div>
                  </div>
               </form>
            </div>
